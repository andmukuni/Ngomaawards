...
<style>
  /* Section background with subtle dark overlay */
  .category-hero{
    position: relative;
    color: #fff;
    /* overlay + image */
    background:
      ...
      url('{{ asset('image/category.jpeg') }}') center/cover no-repeat;
  }
  /* Optional: strengthen card readability on top of photos */
  .overlay-dark{
    background: linear-gradient(to top, rgba(0,0,0,.65), rgba(0,0,0,.15));
  }
</style>

<section class="py-5 category-hero">
  <div class="container">
